                            ...
                            <div class="modal-body">
                                <form id="edit-ruangan-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="edit-nama_ruangan"
                                            name="nama_ruangan" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="edit-kode_ruangan" class="form-label">Kode Ruangan</label>
                                        <input type="text" class="form-control" id="edit-kode_ruangan"
                                            name="kode_ruangan" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="edit-lantai" class="form-label">Lantai</label>
                                        <input type="number" class="form-control" id="edit-lantai" name="lantai"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="edit-kapasitas" class="form-label">Kapasitas</label>
                                        <input type="number" class="form-control" id="edit-kapasitas" name="kapasitas"
                                            required>
                                    </div>
