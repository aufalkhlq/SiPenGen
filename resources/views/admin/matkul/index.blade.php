        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <div class="invoices-create-btn">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#addmatkulModal" class="btn save-invoice-btn">
                        Add Mata Kuliah
                    </button>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-white text-success me-2 edit-btn" data-id="{{$matkul->id}}">
                                            <i class="far fa-edit me-1"></i> Edit
                                        </button>
                                        <button type="button" class="btn btn-sm btn-white text-danger me-2 delete-btn" data-id="{{$matkul->id}}">
    ...
    <div class="modal fade" id="editmatkulModal" tabindex="-1" aria-labelledby="editmatkulModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-matkul-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit-nama_matkul" name="nama_matkul" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit-kode_matkul" class="form-label">Kode Mata Kuliah</label>
                            <input type="text" class="form-control" id="edit-kode_matkul" name="kode_matkul" required>
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="update-matkul-button">Update Mata Kuliah</button>
                </div>
            </div>
        </div>
    </div>
